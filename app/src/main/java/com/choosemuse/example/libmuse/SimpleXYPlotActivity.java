...
public class SimpleXYPlotActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        plot.setDomainLabel("MUSE Mood Rating");
        plot.setRangeLabel("No. of Seconds");
        plot.setTitle("Mood vs. Time");
...
//        Number[] series2Numbers = {0.1, .5, 0.2, 0.2};
        ...
        XYSeries series1 = new SimpleXYSeries(
                Arrays.asList(series1Numbers), SimpleXYSeries.ArrayFormat.Y_VALS_ONLY, "MUSE Mood rating");

        plot.setRangeBoundaries(0, 0.7, BoundaryMode.FIXED);
